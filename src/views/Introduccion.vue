...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Le damos la bienvenida al componente formativo “Patrones de diseño de 
      em software
      | ”. Para comenzar el recorrido, visite el recurso didáctico que se muestra a continuación:
    
    figure.mb-5
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/ZufBcrlUqak" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      ...
      .row.align-items-center.justify-content-around
        .col-lg-6
          p Para la elaboración de este componente, se abordaron varios autores conocidos en 
            ...
            b aseguramiento de la calidad de 
              em software.
        .col-lg-5.order-first.order-lg-last
          figure
            img(src='@/assets/curso/if1.svg' alt='Imagen relacionada')
